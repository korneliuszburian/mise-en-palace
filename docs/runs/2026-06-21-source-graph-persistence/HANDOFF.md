...
Last verified state:
M22 Slice 03 source graph IO schemas are complete. `GOAL.md` defines M22. Slice 00
...
claims, decision edges, and rejections.
...
CLI/API-style source inputs on M22 trust/support vocabulary only.

Blockers/risks:
No Slice 03 blocker. Source graph repository methods, source graph smoke, CLI
