...
> Historical repo-reset audit prompt archived from root on 2026-07-02.
> Not current execution truth.
> Current product truth: `/GOAL.md`, `/PLAN.md`, and `/PLANS.md`.
> Audit outputs live in `docs/reviews/repo-reset-audit/`.
