...
export type SearchDocumentId = BrandedKrnId<"SearchDocumentId">;
export type EmbeddingModelId = BrandedKrnId<"EmbeddingModelId">;
export type EmbeddingId = BrandedKrnId<"EmbeddingId">;
export type RetrievalRunId = BrandedKrnId<"RetrievalRunId">;
export type RetrievalCandidateId = BrandedKrnId<"RetrievalCandidateId">;
export type ActivationDecisionId = BrandedKrnId<"ActivationDecisionId">;
