...
export const observationKind = sqliteEnum("observation_kind", observationKinds);

export const observationPriority = sqliteEnum("observation_priority", observationPriorities);

export const observationConfidence = sqliteEnum(
  "observation_confidence",
  observationConfidences
);

export const observationStatus = sqliteEnum("observation_status", observationStatuses);

export const observationProvenanceKind = sqliteEnum(
  "observation_provenance_kind",
  observationProvenanceKinds
);

export const observationSourceRangeType = sqliteEnum(
  "observation_source_range_type",
  observationSourceRangeTypes
);

export const observationEntityKind = sqliteEnum(
  "observation_entity_kind",
  observationEntityKinds
);

export const observationClaimRelation = sqliteEnum(
  "observation_claim_relation",
  observationClaimRelations
);

export const observationFeedbackEventType = sqliteEnum(
  "observation_feedback_event_type",
  observationFeedbackEventTypes
);

export const observationUsefulness = sqliteEnum(
...
export const observationGroups = sqliteTable(
  "observation_groups",
  {
  ...
  (table) => [
    ...enumChecks("observation_groups", table),
...
export const observationItems = sqliteTable(
  "observation_items",
  {
    id: uuid("id").primaryKey().default(sqliteUuidDefault),
    ...
    ingestedAt: timestamp("ingested_at", { withTimezone: true }).notNull().default(sqliteNow),
  ...
  (table) => [
    ...enumChecks("observation_items", table),
...
export const observationSourceRanges = sqliteTable(
  ...
  (table) => [
    ...enumChecks("observation_source_ranges", table),
...
export const observationEntityEdges = sqliteTable(
  ...
  (table) => [
    ...enumChecks("observation_entity_edges", table),
...
export const observationClaimEdges = sqliteTable(
  ...
  (table) => [
    ...enumChecks("observation_claim_edges", table),
...
export const observationFeedbackEvents = sqliteTable(
  ...
  (table) => [
    ...enumChecks("observation_feedback_events", table),
