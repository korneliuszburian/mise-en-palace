...
const usage = [
  ...
  "krn db --help",
  "krn db readiness",
  "krn db smoke [harness-plan|harness-evidence|source-graph|memory-governance|retrieval-substrate|activation|brain-loop|run-show|heartbeat-worker-authority|codex-adapter|worker-jobs|init-connect|target-repo-harness]",
