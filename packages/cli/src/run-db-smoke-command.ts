...
const formatDecisionPacketReturnLoopSmokeLines = (
  ...
  `Unresolved source dissent governing claim: ${report.sourceDissentGoverningClaimId}`,
  `Unresolved source dissent peer claim: ${report.sourceDissentDissentingClaimId}`,
  `Unresolved source dissent governing decision: ${report.sourceDissentGoverningDecisionId}`,
  ...
  `Unresolved source dissent brief remains executable: ${yesNo(report.sourceDissentBriefRemainsExecutable)}`,
