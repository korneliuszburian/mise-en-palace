...
const dbUsage = [
  ...
  "[harness-plan|harness-evidence|source-graph|memory-governance|retrieval-substrate|activation|brain-loop|heartbeat-worker-authority|codex-adapter|worker-jobs|init-connect|target-repo-harness]",
  "",
