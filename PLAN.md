...
`packages/harness/src/reflection/reflectionCandidateWriter.ts`, core evidence
command normalization, or another narrower target if source inspection shows
lower risk.
...
full Fallow moved: dupes 136 -> 122; health 117 -> 90
```
