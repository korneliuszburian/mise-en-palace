...
Current gaps: M20 still needs DB runtime inventory, local pgvector setup path, migration readiness command, doctor DB readiness refinement, minimal persistence smoke path, and final blocker/handoff closure.
