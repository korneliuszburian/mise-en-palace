...
CLI scoped test typecheck: active smoke runs strict `tsc`; codex/reflect/observe/evidence/source/memory plus parser tests joined the clean subset
...
Latest report: `docs/runs/2026-07-03-cli-parse-test-typecheck-widening.md`.
...
This is not full CLI test typecheck; parser tests and targeted command-group fixture batches are now in the clean subset.
```
