...
heartbeat acquisition review: linked evidence first, then candidate-only low-to-high cost escalation
...
IMR-18: acquisition candidates expose candidate-only low-to-high cost escalation.
```
