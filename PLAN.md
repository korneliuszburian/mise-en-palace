...
reviewed feedback memory effect: eval:memory-advantage reports prior feedback refs, baseline/KRN outcomes, selected/excluded ids, context-size cost, and stale/adversarial negative classes
