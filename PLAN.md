...
Current active Bead: `mise-en-palace-ovit` feedback/forget loop.
Latest closed Bead: `mise-en-palace-9rnq` corpus closure.
Next ready Beads after `ovit`: `mise-en-palace-qqet` proof/docs cleanup, `mise-en-palace-rr9b` decision-packet benchmark, `mise-en-palace-v4e9` second-repo dry run.
