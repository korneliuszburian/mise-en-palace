...
source graph relation ranking proof: invalidates/duplicates are DB-smoke visible; eval:source-graph-ranking covers supports/duplicates/invalidates plus held-out depends_on/qualifies relation-shape readback
