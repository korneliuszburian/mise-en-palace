...
- MM-00 through MM-17A and MM-16R of the memory ideal-state plan are complete.
...
- Built but not proven end-to-end: observation runtime and prefix selection.
  MM-17B-MM-17F repair slices must dogfood persisted observations, enforce
  typed lineage, fix project scoping, validate timestamps, and harden redaction
  before reflection.
