...
CLI scoped test typecheck: active smoke runs strict `tsc`; command fixture, parser, and small helper tests joined the clean subset
...
Latest report: `docs/runs/2026-07-03-cli-helper-test-typecheck-widening.md`.
...
This is not full CLI test typecheck; helper, parser, and targeted command-group fixture batches are now in the clean subset.
```
