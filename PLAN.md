...
CLI scoped test typecheck: active smoke runs strict `tsc`; codex/reflect fixtures joined the clean subset
...
Goal: expand the scoped strict TypeScript gate with the reflect command test batch.
...
Latest report: `docs/runs/2026-07-03-cli-test-typecheck-reflect-batch.md`.

Task boundary:

```txt
packages/cli/tsconfig.tests.clean.json now includes reflect.test.ts.
The reflect test fixture matches runtime interfaces without casts or assertion changes.
