...
reviewed feedback memory effect: eval:memory-advantage reports prior feedback refs beside later task selection, baseline outcome, KRN outcome, selected memory/source ids, and context-size cost
