...
CLI scoped test typecheck: active smoke runs strict `tsc`; codex/reflect/observe/evidence fixtures joined the clean subset
...
Latest report: `docs/runs/2026-07-03-cli-test-typecheck-evidence-batch.md`.
