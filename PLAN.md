...
CLI scoped test typecheck: active smoke runs strict `tsc`; selected command, parser, helper, smoke/readiness, and doctor tests joined the clean subset
...
Latest report: `docs/runs/2026-07-03-cli-small-command-test-typecheck-widening.md`.
...
This is not full CLI test typecheck; selected command, helper, parser, smoke/readiness, doctor, and targeted fixture batches are now in the clean subset.
```
