...
run/review/evidence golden command test batch. This does not prove full CLI
test typecheck; it widens the clean subset without runtime assertion changes.

Latest slice:

```txt
CLI small command test typecheck widening slice.
Report:
