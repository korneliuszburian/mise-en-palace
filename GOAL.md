...
- M27 is complete.
- MM-00 through MM-19 and MM-16R are complete.
...
- Observational memory is not proven end-to-end yet: reflection repository/input
  selection, candidate generation, review gates, and activation integration are
  next.
