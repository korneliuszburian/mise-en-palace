...
- M27 is complete.
- MM-00 through MM-30A and MM-16R are complete.
...
- Observational memory is not proven end-to-end yet: memory abstain behavior,
  activation integration, and golden behavior proof are next.
