...
- M27 is complete.
- MM-00 through MM-24 and MM-16R are complete.
...
- Observational memory is not proven end-to-end yet: repository/runtime
  no-mutation proof, review gates, and activation integration are next.
