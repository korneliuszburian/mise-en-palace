...
V110..V185: revision-note, checkpoint rollup, smoke coverage, pattern-gate,
...
source-to-decision skill metadata, evidence review skill provenance, and Codex
adapter skill metadata guards complete.
